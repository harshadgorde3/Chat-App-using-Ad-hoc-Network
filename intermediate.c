...
int main(int argc, char **argv)
{
    ...
    servaddr.sin_addr.s_addr = inet_addr("192.168.1.137");//intermediate
    servaddr.sin_port = htons(SERV_PORT);

    cliaddr1.sin_family=AF_INET;
    cliaddr1.sin_addr.s_addr=inet_addr("192.168.1.103");//server
    cliaddr1.sin_port=htons(SERV_PORT);

    cliaddr2.sin_family=AF_INET;
    cliaddr2.sin_addr.s_addr=inet_addr("192.168.1.208");//client
